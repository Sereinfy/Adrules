...
class ReadMe(object):
    ...
    def __subscribeLink(self, fileName:str, url:str=None):
        ...
        for i in range(1, len(self.proxyList)):
            ...
            if proxy.startswith("https://gcore.jsdelivr.net/"):
                link += " [加速链接%d](%s/Sereinfy/Adrules@main/rules/%s) |"%(i, proxy, fileName)
            else:
    ...
    def regenerate(self):
        ...
        with open(self.filename, 'a') as f:
            ...
            f.write("6. 不再引用[xinggsf rule](https://raw.githubusercontent.com/xinggsf/Adblock-Plus-Rule/master/rule.txt)，误杀较多，见 Issues [44](https://github.com/217heidai/adblockfilters/issues/44)、[131](https://github.com/217heidai/adblockfilters/issues/131)、[172](https://github.com/217heidai/adblockfilters/issues/172)。\n")
            f.write("\n")
