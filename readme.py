...
class ReadMe(object):
    ...
    def regenerate(self):
        ...
        with open(self.filename, 'a') as f:
            ...
            f.write("| 规则1'：DNS 拦截 Lite | [原始链接](https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdnslite.txt) | [加速链接](https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdnslite.txt) |\n")
            ...
            f.write("| 规则2'：插件拦截 Lite | [原始链接](https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockfilterslite.txt) | [加速链接](https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockfilterslite.txt) |\n")
            f.write("\n")
            f.write("## 上游规则源\n")
            ...
            f.write("5. 不再引用[NEO DEV HOST](https://github.com/neodevpro/neodevhost/blob/master/lite_adblocker)，原因见[Issues 85](https://github.com/Sereinfy/Adrules/issues/85)。\n")
            f.write("\n")
            ...
            f.write("[![Star History Chart](https://api.star-history.com/svg?repos=Sereinfy/Adrules&type=Date)](https://star-history.com/#Sereinfy/Adrules&Date)\n")