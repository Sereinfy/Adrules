...
class ReadMe(object):
    ...
    def regenerate(self):
        ...
        with open(self.filename, 'a') as f:
            ...
            f.write("Forked From [217heidai/adblockfilters](https://github.com/217heidai/adblockfilters) \n")
            f.write("\n")
            f.write("## 说明\n")
            ...
            f.write("|:-|:-|:-|:-|\n")
            f.write("| 规则1：DNS 拦截 | [原始链接](https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdns.txt) | [加速链接](https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdns.txt) | AdGuard、AdGuard Home 等 |\n")
            f.write("| 规则1'：DNS 拦截 Lite | [原始链接](https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdnslite.txt) | [加速链接](https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdnslite.txt) | AdGuard、AdGuard Home 等 |\n")
            f.write("| 规则2：插件拦截 | [原始链接](https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockfilters.txt) | [加速链接](https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockfilters.txt) | AdGuard 等 |\n")
            f.write("| 规则2'：插件拦截 Lite | [原始链接](https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockfilterslite.txt) | [加速链接](https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockfilterslite.txt) | AdGuard 等 |\n")
            f.write("| 规则3：Domain 拦截 | [原始链接](https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdomain.txt) | [加速链接](https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdomain.txt) | InviZible Pro、personalDNSfilter 等 |\n")
            f.write("| 规则3'：Domain 拦截 Lite | [原始链接](https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdomainlite.txt) | [加速链接](https://mirror.ghproxy.com/https://raw.githubusercontent.com/Sereinfy/Adrules/main/rules/adblockdomainlite.txt) | InviZible Pro、personalDNSfilter 等 |\n")
